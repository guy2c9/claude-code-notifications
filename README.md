...
Place a PNG file (512x512 or larger) at `~/.claude/claude-icon.png`. This will appear in your notification banners.

If you skip this step, notifications will use the default terminal-notifier icon.
